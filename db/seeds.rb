...
wines = Wine.create([
  ...
  {vintage: '2005', country: 'France', region: 'Burgundy', purveyor: 'Pernanad-Vergelesses-Dubreuil-Fontaine', grape: '', style: '', btg: '', btb: '', menuable_type: 'Menu', menuable_id: '3', user_id: '3'}, ])
